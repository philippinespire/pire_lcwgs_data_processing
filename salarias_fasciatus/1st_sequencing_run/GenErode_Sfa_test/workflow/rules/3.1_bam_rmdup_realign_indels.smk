...
rule merged_index_bam_qualimap:
    ...
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-qualimap:2.2.2d--1.sif"
    shell:
        """
        mem=$(((6 * {threads}) - 2))
        unset DISPLAY
...
rule rmdup_modern_bams:
    ...
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-picard:2.26.6--hdfd78af_0.sif"
    shell:
        """
        mem=$(((6 * {threads}) - 2))
...
rule indel_realigner_targets:
    ...
    singularity:
        "/cm/shared/containers/docker/broadinstitute-gatk3:3.7-0.sif"
    shell:
        """
