...
The test lane data are back and can be found at https://gridftp.tamucc.edu/genomics/20230123_PIRE-Par-lcwgs-testlane/ The sequence name decode sheet is in with the data.
