...
File:
errorsummary.val
Abu-CPnd_015-Ex1-1C-lcwgs-1-2_mitoscaf.fa.val
...
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2_mitoscaf.fa.gbf

- 4. The mitochondrial genome in Fasta format.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2.fasta
...
the file Abu-CPnd_015-Ex1-1C-lcwgs-1-2_mitoscaf.fa.gbf has no annotation problem.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2_mitoscaf.fa.sqn

- 7. The feature table for the mitochondrial genome.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2_mitoscaf.fa.tbl
...
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2.cds

- 9. The rRNA gene sequences for each rRNA gene.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2.rrna

- 10. The tRNA gene sequences for each tRNA gene.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2.trna

- 11. The control region sequence.
File:
Abu-CPnd_015-Ex1-1C-lcwgs-1-2.misc_feature
