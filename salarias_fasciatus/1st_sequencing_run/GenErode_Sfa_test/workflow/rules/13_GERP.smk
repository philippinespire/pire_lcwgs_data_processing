...
rule outgroup_fastqc:
    ...
    threads: 2
    singularity:
        "/cm/shared/containers/docker/biocontainers-fastqc:v0.11.9_cv7.sif"
    shell:
        """
...
rule outgroup_fastqc_multiqc:
    ...
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-multiqc:1.9--pyh9f0ad1d_0.sif"
    shell:
        """
...
rule align2target:
    ...
    singularity:
        "/cm/shared/containers/docker/nbisweden-generode-bwa:latest.sif"
    shell:
        """
...
rule index_gerp_bams:
    ...
    singularity:
        "/cm/shared/containers/docker/biocontainers-samtools:v1.9-4-deb_cv1.sif"
    shell:
        """
...
rule bam2fasta:
    ...
    threads: 2
    singularity:
        "/cm/shared/containers/docker/biocontainers-samtools:v1.9-4-deb_cv1.sif"  # This container includes python 3.7.6 with default python modules
    shell:
        """
...
rule split_ref_contigs:
    ...
    threads: 1
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-seqtk:1.3--hed695b0_2.sif"
    shell:
        """
        if [ ! -d {output.fasta_dir} ]; then
          mkdir -p {output.fasta_dir};
...
rule compute_gerp:
    ...
    threads: 4
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-gerp:2.1--hfc679d8_0.sif"
    shell:
        """
...
rule repmasked_bcf2vcf_gerp:
    ...
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-bcftools:1.9--h68d8f2e_9.sif"
    shell:
        """
