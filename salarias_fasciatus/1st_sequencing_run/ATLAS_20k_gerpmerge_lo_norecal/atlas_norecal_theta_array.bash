...
JOBID=$(sbatch --array=0-$((${#all_samples[@]}-1))%20 \
       ...
       --partition main \
       -t 96:00:00 \
       /home/e1garcia/shotgun_PIRE/pire_lcwgs_data_processing/salarias_fasciatus/1st_sequencing_run/ATLAS_nogerp_test/atlas_recalnogerp_theta_array.sbatch ${BAMDIR} ${REFLOC} ${OUTDIR})
