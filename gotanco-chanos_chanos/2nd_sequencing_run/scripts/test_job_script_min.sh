...
INDIR=fq_fp1_clmp_fp2_stragglers #$1      					#INDIR=/work/hobi/cbird/pire_shotgunWGAvNoWGA/4sumstats_fq_fstp
OUTDIR=min_2_fq_fp1_clmp_fp2_fqscrn_kl #$2     
#TMPDIR=$(echo ${3}/fastqscrn${SLURM_ARRAY_TASK_ID})
FQPATTERN="*.fq.gz" #$3       					#PATTERN="*.fq.gz"
...
INFILES=fq_fp1_clmp_fp2_stragglers/Cch-CCS_001-6D-lcwgs-1-2.clmp.fp2_r2.fq.gz
echo INFILES:
echo ${INFILES}
