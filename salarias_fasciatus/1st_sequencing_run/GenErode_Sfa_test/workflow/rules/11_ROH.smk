...
rule filter_vcf_hwe:
    ...
    singularity:
        "/cm/shared/containers/docker/biocontainers-vcftools:v0.1.16-1-deb_cv1.sif"
    shell:
        """
...
rule vcf2plink_hwe:
    ...
    singularity:
        "/cm/shared/containers/docker/quay.io-biocontainers-plink:1.90b6.12--heea4ae3_0.sif"
    shell:
        """
