...
cov_matrix_angsd <- as.matrix(read.table("C:/Users/salva/Downloads/Sfa_angsd_analysis/angsd_notrans_snps_pca_it500_noinv_subset.cov"))
#Matrix is in order 1-222 on each side
#sample_table <- read_table("sample_table_merged_allpop.tsv")

bamlist=read.table("C:/Users/salva/Downloads/Sfa_angsd_analysis/bam_list_all_subset.txt")
